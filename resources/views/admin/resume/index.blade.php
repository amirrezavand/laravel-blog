    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Resumes</h3>
                <p class="text-subtitle text-muted">For management Resumes</p>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h4 class="card-title">Resume items ( total : {{$resumes->total()}} )</h4>
                        <a class="btn btn-success btn-sm" href="{{route('admin.resume.create')}}">Create <i
                                class="bi bi-plus position-relative" style="top: 3px;"></i></a>
                    </div>
                    <div class="row px-4">
                        <div class="col-12 col-md-6">
                            <form action="{{route('admin.resume.index')}}" method="get">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-warning btn-sm"
                                               href="{{route('admin.resume.edit',['resume'=>$item->id])}}">edit</a>
                                            <a class="btn btn-danger btn-sm" href="#"
                                               onclick="event.preventDefault(); document.getElementById('delete-{{$loop->index}}').submit();">delete</a>
                                            <form
                                                action="{{route('admin.resume.destroy',['resume'=>$item->id])}}"
