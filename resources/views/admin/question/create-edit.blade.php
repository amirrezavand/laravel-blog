    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Question</h3>
                <p class="text-subtitle text-muted">For Create and Edit Question</p>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post"
                              action="@if(getRouteAction()=='create') {{route('admin.question.store')}} @else {{ route('admin.question.update',['question'=>$question->id])}} @endif"
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control @error('question') is-invalid @enderror"
                                           id="question"
                                           placeholder="Question" value="{{old('question',$question->question)}}" name="question">
                                    @error('question')
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control @error('answer') is-invalid @enderror"
                                           id="answer"
                                           placeholder="Answer" value="{{old('answer',$question->answer)}}" name="answer">
                                    @error('answer')
                                    <div class="invalid-feedback">
                                        <i class="bx bx-radio-circle"></i>
                                        {{$message}}
