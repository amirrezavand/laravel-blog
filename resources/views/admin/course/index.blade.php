    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Courses</h3>
                <p class="text-subtitle text-muted">For management Courses</p>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h4 class="card-title">Blog items ( total : {{$courses->total()}} )</h4>
                        <a class="btn btn-success btn-sm" href="{{route('admin.course.create')}}">Create <i
