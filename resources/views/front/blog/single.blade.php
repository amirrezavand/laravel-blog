                ...
                <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="article_detail_wrapss single_article_wrap format-standard">
                        <div class="article_body_wrap">
                            ...
                            <div class="article_featured_image">
                                <img class="img-fluid" src="/front/img/h-5.png" alt="">
                            </div>

                            <div class="article_top_info">
                                <ul class="article_middle_info">
                                    <li><a href="#"><span class="icons"><i class="ti-user"></i></span>توسط الهام کریمی</a></li>
                    ...
                    <div class="article_detail_wrapss single_article_wrap format-standard">
                        ...
                        <div class="article_posts_thumb">
                            <span class="img"><img class="img-fluid" src="/front/img/user-1.jpg" alt=""></span>
                            <h3 class="pa-name">حسام موسوی</h3>
                                ...
                                <div class="comment-list">
                                    <ul>
                                        ...
                                        <li class="article_comments_wrap">
                                            <article>
                                                <div class="article_comments_thumb">
                                                    <img src="/front/img/user-5.jpg" alt="">
                                                </div>
                                                <div class="comment-details">
                                                    <div class="comment-meta">
                                                        <div class="comment-left-meta">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="single_widgets widget_thumb_post">
                        ...
                        <ul>
                            <li>
										<span class="left">
											<img src="/front/img/blog-sm-01.jpg" alt="" class="">
										</span>
                                <span class="right">
                            ...
                            <li>
										<span class="left">
											<img src="/front/img/blog-sm-02.jpg" alt="" class="">
										</span>
                                <span class="right">
                            ...
                            <li>
										<span class="left">
											<img src="/front/img/blog-sm-03.jpg" alt="" class="">
										</span>
                                <span class="right">
