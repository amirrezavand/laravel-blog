                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="list_facts_wrap">
                        ...
                        <div class="list_facts">
                            <div class="list_facts_icons" style="flex: 0 0 40px"><i class="ti-desktop"></i></div>
                            <div class="list_facts_caption">
                                <h4>نظارت دقیق بر فعالیت های دانشجویان</h4>
                                <p class="text-justify">هر کجای ایران یا دنیا که هستید، کافه جی آی اس صورت زنده بر فعالت شما نظارت دارد و در جهت رفع موانع شما گام بر می دارد.</p>
                            </div>
                        </div>
                        <div class="list_facts" >
                            <div class="list_facts_icons" style="flex: 0 0 40px"><i class="ti-heart"></i></div>
                            <div class="list_facts_caption">
                                <h4>شفافیت قیمت و تضمین پایین‌ترین قیمت‌</h4>
                                <p class="text-justify">در کافه جی آی اس با توجه به زمان اختصاصی زیاد در تهیه آموزش ها و مشاوره و حل مشکل دانشجویان، سعی گردیده است که هزینه خدمات به نسبت رقبا پایین تر باشد. </p>
                            </div>
                        </div>
                        <div class="list_facts">
                            <div class="list_facts_icons" style="flex: 0 0 40px"><i class="ti-harddrives"></i></div>
                            <div class="list_facts_caption">
                                <h4>آموزش با متد جدید</h4>
                                <p class="text-justify">در کافه جی آی اس سعی شده است جدیدترین متدها در راستای با کیفیت نمودن پروسه یادگیری، به کار گرفته شود و همواره در تلاش هستیم به روز ترین آموزش ها را در راستای ارتقای شما در سایت قرار دهیم.</p>
                            </div>
                        </div>
