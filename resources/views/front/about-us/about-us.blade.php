                    ...
                    <div class="list_facts_wrap">
                        ...
                        <div class="list_facts">
                            ...
                            <div class="list_facts_caption">
                                ...
                                <p>هر کجای ایران یا دنیا که هستید، آستراکدر صورت زنده بر فعالت شما نظارت دارد و در جهت رفع موانع شما گام بر می دارد.</p>
                            </div>
                        </div>
                        <div class="list_facts" >
                            ...
                            <div class="list_facts_caption">
                                ...
                                <p>در آسترا کدر با توجه به زمان اختصاصی زیاد در تهیه آموزش ها و مشاوره و حل مشکل دانشجویان، سعی گردیده است که هزینه خدمات به نسبت رقبا پایین تر باشد. </p>
                            </div>
                        </div>
                        <div class="list_facts">
                            ...
                            <div class="list_facts_caption">
                                ...
                                <p>در آستراکدر سعی شده است جدیدترین متدها در راستای با کیفیت نمودن پروسه یادگیری، به کار گرفته شود و همواره در تلاش هستیم به روز ترین آموزش ها را در راستای ارتقای شما در سایت قرار دهیم.</p>
                            </div>
                        </div>
